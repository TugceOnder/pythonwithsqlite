...
class Kitap():
    ...
    def __str__(self): #sql veritabanına baglanabilirim
...
class Kütüphane():
    ...
    def baglantiyi_kes(self):
        self.baglanti.close() # veri tabanı baglantıyı kapatacak
    ...
    def kitapları_goster(self):
        ...
        kitaplar = self.cursor.fetchall()  # kitaplar değişkeni tanımladık biligler var sa kitaplar değişkenine gelcek
    ...
    def kitap_sorgula(self,isim):
        ...
        sorgu = "Select * From kitaplar where isim = ?"  # sorgu

        self.cursor.execute(sorgu,(isim,)) #kitabı isme göre sorgulama
    ...
    def kitap_ekle(self,kitap):
        ...
        self.baglanti.commit()  # yazmasak eklenen kitaplar database kısmına  gitmez
